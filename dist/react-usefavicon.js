...
function useFavicon() {
  ...
  const [originalHref, setOriginalHref] = React__namespace.useState(null); // Grab initial favicon on mount
...
const drawTextBubble = (context, faviconSize, options) => {
  const {
    ...
    font = "sans-serif"
  } = options; // these numbers are pure trial and error I should have thought about them more it works ok though
...
//# sourceMappingURL=react-usefavicon.js.map
